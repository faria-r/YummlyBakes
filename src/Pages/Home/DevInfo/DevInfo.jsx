...
const DevInfo = () => {
  return (
    <div className="w-auto  p-6 text-center mt-8 mb-16 ">
       <h2 className='w-max mx-auto border-x-[1px] px-4 border-orange-500 text-center font-mono font-bold text-2xl lg:text-5xl my-16'>Meet Developer</h2>
      <div className="w-[80vw] mx-auto lg:flex justify-center items-center text-center p-6">
        <div className="mr-16 mx-auto">
          ...
          <div className=" text-start mt-6">
             ...
             <span className="text-xs leading-none">  Department of </span> <br />
                <span className="font-mono font-bold">
                  Computer Science & Technology
                </span>
              </p>
              <p className="">Compact Polytechnic Institute</p>
              <p className=""> June <span className="font-mono font-semibold">2020</span> - Present</p>
            </div>
        </div>
        <div className="text-center lg:text-start w-[50vw] mx-auto pt-6 lg:pt-2">
          ...
          <div className=" pt-6  w-[30vw] lg:mt-16 mb-4 ">
            <div>
