...
const PickWeek = () => {
    return (
        <div>
            <div className=" p-6 mt-24 w-[90vw] mx-auto flex justify-center">
            <div className='w-[50%] bg-orange-50 p-6 text-center pt-24'>
<h2 className='font-mono text-2xl'>PICK OF THE WEEK</h2>
<h1 className='font-[roboto]  font-bold text-5xl py-6'>Apple Pie Overnight Oats</h1>
