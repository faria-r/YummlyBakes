        ...
        {user ? (
          <div className="ml-16">
            <button
              ...
              className="btn text-xl  h-8 px-12 py-0 text-yellow-500  bg-transparent border-none  rounded-none "
            >
              Logout
            </button>
          </div>
          ...
          <div className="ml-16">
            <button
              onClick={handleLogin}
              className="btn text-xl  h-8 px-12 py-0 bg-transparent border-none rounded-none text-yellow-500"
            >
              Login
            </button>
          </div>
