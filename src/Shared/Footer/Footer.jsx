...
const Footer = () => {
  return (
    <div className="w-[90vw] mx-auto mt-8 pt-8 pb-24 ">
      <h2 className="text-3xl my-6 bg-gradient-to-r from-orange-500 via-green-600 to-yellow-400 inline-block text-transparent bg-clip-text">Yummly Bakes - Recipes</h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 w-[80vw] p-6  items-start  font-sans">
        <div>
          <h2 className="text-xl lg:mt-6">Share Your Recipes With Us</h2>
        </div>
        <div className="flex-col justify-center font-bold">
          ...
          <p className="lg:ml-[2%]">QUICK LINKS</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 p-4 w-[90vw] ">
        <div className="text-2xl bg-transparent"><img src={logo} className=" w-16 bg-transparent"alt="" /></div>
        <div className="lg:-ml-[38%]">
          ...
          <div className="flex justify-start text-4xl gap-4">
            <div><img className="w-8" src={logo1} alt="" srcset="" /></div>
            <div><img className="w-8" src={logo2} alt="" srcset="" /></div>
          </div>
        </div>
      </div>
      <hr />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mt-6 gap-24 lg:gap-4">
        <div className="text-2xl relative">
            <h2>Powered By <span className="font-bold underline bg-gradient-to-r from-orange-500 via-green-600 to-yellow-400 inline-block text-transparent bg-clip-text">Yummly Bakes</span></h2>
