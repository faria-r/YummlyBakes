...
const HappyCustomer = () => {
    return (
        <div>
            ...
            <div className="my-16 text-center w-[40vw] mx-auto">
        <Counter></Counter>
      </div>
            ...
            <Customer photo={"https://static.toiimg.com/thumb/imgsize-123456,msid-107264019,width-200,resizemode-4/107264019.jpg"} name={'Sultana Faria'} review={'I love that the website offers personalized recipe recommendations. Its like having a personal chef who knows exactly what I like!'}></Customer>
